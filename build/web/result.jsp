            ...
            <div class="container mb-5"> 
                <div class="row"style=" padding: 1rem; background-color: rgba(144,144,144,.075); margin-left: 3rem; margin-right: 3rem; margin-top: 2rem; ">
                    ...
                    <div class="col-4" style=" border-right: solid #000 3px;">
                        ...
                        <p style="color: blue; font-weight: bold; margin-bottom: 1rem;">Total Marks : ${correctNumber} / ${count} </p>
                    </div>
                    <div class="col-4" style="border-right-color: black;">
                        ...
                        <p style="color: blue; font-weight: bold; margin-bottom: 1rem;">End time : ${end}</p>
                                    ...
                                    <div class="row"> 
                                        <div class="col-md-6"> 
                                            ...
                                            <label class="box fifth w-100">
                                                <div class="course"> 
                                                    <input  <c:forEach var="e" items="${requestScope.oList}">
                                                            ${e == a.o1 ? "checked" : ""}
                                                        </c:forEach>
                                                        ${correctNumber!=null?"disabled ":""}  required="" name="option_${a.id}" value="${a.o1}" type="radio"> 
                                       ...
                                       ${correctNumber!=null?"disabled ":""}  type="radio" required="" name="option_${a.id}" value="${a.o2}""> 
                                       ...
                                       ${correctNumber!=null?"disabled ":""}  type="radio" required=""name="option_${a.id}" value="${a.o3}">
                                       ...
                                       ${correctNumber!=null?"disabled ":""}  type="radio" required="" name="option_${a.id}"value="${a.o4}" > 
