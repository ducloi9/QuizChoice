                ...
                <div class="row"style=" padding: 1rem; background-color: rgba(144,144,144,.075); margin-left: 3rem; margin-right: 3rem; margin-top: 2rem; ">
                                ...
                                <div class="row"> 
                                    <div class="col-md-6"> 
                                        ...
                                        <label class="box fifth w-100">
                                            <div class="course"> 
                                                <input required="" name="option_${a.id}" value="${a.o1}" type="radio"> 
                                    ...
                                    <div class="col-md-6"> 
                                        ...
                                        <label class="box sixth w-100"> 
                                            <div class="course">
                                                <input type="radio" required="" name="option_${a.id}" value="${a.o2}""> 
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <label class="box seveth w-100"> 
                                            <div class="course"> 
                                                <input type="radio" required=""name="option_${a.id}" value="${a.o3}">
                                    ...
                                    <div class="col-md-6"> 
                                        <label class="box eighth w-100"> 
                                            <div class="course"> 
                                                <input type="radio" required="" name="option_${a.id}"value="${a.o4}" > 
                    ...
                    <div class="col-12"> 
                        <div class="d-flex justify-content-center"> 
                            <input type="submit" class="btn btn-primary px-4 py-2 fw-bold" value="Submit"> 
                        </div> 
                    </div> 
                </div>
            </div>
